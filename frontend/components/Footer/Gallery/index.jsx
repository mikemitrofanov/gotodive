  ...
  return (
    <article className={styles.gallery_wrapper}>
      ...
      <div className={styles.wrapper_img}>
        <a data-fancybox='' data-src='images/footer/fancybox_photo/img1_big.png'>
          <img className={styles.img_gallery} src='images/footer/photo/img1.png' />
        </a>
        <a data-fancybox='' data-src='images/footer/fancybox_photo/img2_big.png'>
          <img className={styles.img_gallery} src='images/footer/photo/img2.png' />
        </a>
        <a data-fancybox='' data-src='images/footer/fancybox_photo/img3_big.png'>

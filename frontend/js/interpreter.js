const dictionary = {
  "ru": {
    ...
    "_popular": "ПОПУЛЯРНОЕ",
    "_sign_up": "Записаться",
    "_our_team": "НАША КОМАНДА",
    "_name_2": "Юрии Прохватило",
    "_name_3": "Рик Санчес",
    "_great_and_terrible": "великий и ужасный",
    "_just_darling": "просто душка",
    "_write_to_us": "ПИШИТЕ НАМ",
    "_name": "Имя",
    "_phone": "Телефон",
    "_message": "Сообщение",
    "_send": "Отправить"
  ...
  "ua": {
    ...
    "_sign_up": "Записатися",
    "_our_team": "НАША КОМАНДА",
    "_name_2": "Юріі Прохватіло",
    "_name_3": "Рік Санчез",
    "_great_and_terrible": "великий і жахливий",
    "_just_darling": "просто душка",
    "_write_to_us": "ПИШІТЬ НАМ",
    "_name": "Ім'я",
    "_phone": "Телефон",
  ...
  "en": {
    ...
    "_sign_up": "Sign up",
    "_our_team": "OUR TEAM",
    "_name_2": "Yurii Prokhvatilo",
    "_name_3": "Rick Sanchez",
    "_great_and_terrible": "great and terrible",
    "_just_darling": "just darling",
    "_write_to_us": "WRITE TO US",
    "_name": "Name",
    "_phone": "Phone",
    "_message": "Message",
    "_send": "Send",
